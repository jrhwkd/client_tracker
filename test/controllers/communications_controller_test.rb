...
class CommunicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create communication" do
    assert_difference('Communication.count') do
      post communications_url, params: { communication: { client_id: @communication.client_id, comment: @communication.comment } }
    end
  ...
  test "should update communication" do
    patch communication_url(@communication), params: { communication: { client_id: @communication.client_id, comment: @communication.comment } }
